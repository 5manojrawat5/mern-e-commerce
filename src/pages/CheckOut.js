...
function CheckOut(){
    ...
    return(
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex px-5 justify-between gap-x-6 py-5 border-solid border-2 border-gray-200">
          ...
          <li key={product.id} className="flex py-6">
            ...
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex flex-1 items-end justify-between text-sm">
                ...
                className='inline text-sm mr-5 font-medium leading-6 text-gray-900'>Qty</label>
